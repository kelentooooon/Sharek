...
const TestTemes = () => {
  ...
  const themeMetadata = {
    Theme1: { name: 'قالب كلاسيكي', description: 'تصميم أنيق وبسيط', color: 'from-slate-50 to-blue-100' },
    Theme2: { name: 'قالب عصري', description: 'تصميم داكن وحديث', color: 'from-black to-gray-800' },
    Theme3: { name: 'قالب احترافي', description: 'مناسب للأعمال', color: 'from-blue-50 to-indigo-100' },
    Theme4: { name: 'قالب ملون', description: 'تصميم مفعم بالألوان', color: 'from-purple-50 to-pink-100' },
    Theme5: { name: 'قالب بسيط', description: 'تصميم مينيمال', color: 'from-gray-50 to-gray-100' },
    Theme6: { name: 'قالب ناعم', description: 'ألوان هادئة', color: 'from-green-50 to-teal-100' },
    Theme7: { name: 'قالب دافئ', description: 'ألوان دافئة', color: 'from-orange-50 to-red-100' },
    Theme8: { name: 'قالب بارد', description: 'ألوان باردة', color: 'from-cyan-50 to-blue-100' },
    Theme9: { name: 'قالب متدرج', description: 'تدرجات جميلة', color: 'from-violet-50 to-purple-100' },
    Theme10: { name: 'قالب عملي', description: 'للاستخدام اليومي', color: 'from-amber-50 to-yellow-100' },
    Theme11: { name: 'قالب أنيق', description: 'تصميم راقي', color: 'from-rose-50 to-pink-100' },
    Theme12: { name: 'قالب حديث', description: 'مواكب للعصر', color: 'from-emerald-50 to-green-100' },
    Theme13: { name: 'قالب مبتكر', description: 'تصميم إبداعي', color: 'from-sky-50 to-cyan-100' },
    Theme14: { name: 'قالب مميز', description: 'يلفت الأنظار', color: 'from-indigo-50 to-blue-100' },
    Theme15: { name: 'قالب فاخر', description: 'للمناسبات الخاصة', color: 'from-purple-50 to-violet-100' },
    Theme16: { name: 'قالب عملي', description: 'سهل الاستخدام', color: 'from-teal-50 to-cyan-100' },
    Theme17: { name: 'قالب جذاب', description: 'تصميم لافت', color: 'from-pink-50 to-rose-100' },
      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-6">
            اختر من مجموعة واسعة من القوالب المصممة خصيصاً لبطاقات الأعمال الرقمية
          </p>
        ...
        {viewMode === 'grid' ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {Object.keys(themeComponents).map((themeName) => {
              ...
              return (
                ...
                >
                  {/* Theme Preview */}
                  <div className={`h-48 bg-gradient-to-br ${metadata.color} p-4 flex items-center justify-center relative overflow-hidden`}>
                  ...
                  {/* Theme Info */}
                  <div className="p-4">
                    <h3 className="font-bold text-gray-800 mb-1">{metadata.name}</h3>
                    <p className="text-sm text-gray-600 mb-2">{metadata.description}</p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-blue-600 font-medium">{themeName}</span>
                      {isSelected && (
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-80 bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4">اختر القالب</h2>
              ...
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-600">{themeMetadata[selectedTheme].description}</p>
                  </div>

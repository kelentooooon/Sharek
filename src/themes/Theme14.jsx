...
const Theme14 = () => {
    return (
        <div className="min-h-screen flex justify-center items-center font-sans">
            <div className="w-full max-w-sm bg-[#1B1464]">
                <div className="relative mb-16">
                    ...
                    <div className="absolute inset-x-0 bottom-0 ">
                        <img src={profileimg} alt="profile" className="w-25 sm:w-30 h-25 sm:h-30 rounded-full ml-4 object-cover" />
                        <div className="-space-y-3 bg-gradient-to-b from-transparent to-[#1B1464] p-4 text-white">
                ...
                <div className="mb-8">
                    <h2 className="text-3xl sm:text-4xl font-bold text-[#FFDA00] mb-4 text-center">
                        About Me
                    </h2>
                ...
                <div className="mb-8">
                    <h2 className="text-3xl sm:text-4xl font-bold text-[#FFDA00] mb-8 text-center">
                        Contact Me
                    </h2>
